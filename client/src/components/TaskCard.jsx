  ...
  return (
    <div className="TaskCard">
      <div className="TasCard_Checktitle">
        <span>
          {task.done === 1 ? (
            <BsCheck2Circle onClick={()=>{handleDone()}} className="BsCheck2Circle" />
          ) : (
            <RxCrossCircled onClick={()=>{handleDone()}} className="RxCrossCircled" />
          )}
        </span>
        <h2>{task.title}</h2>
      </div>
      ...
      <div className="TaskCard_DateButtons">
        ...
        <div className="TaskCard_DateButtons__buttons">
          <button onClick={()=>navegate(`/edit/${task.id}`)}><RxPencil2/></button>
